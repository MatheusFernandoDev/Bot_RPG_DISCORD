...
def merc_leonine():
    ...
    atributos1 = {"for": random.randint(1,8) + random.randint(1,3), "vig": random.randint(1,8), "des": random.randint(1,8), "atl": random.randint(1,8) + random.randint(1,3), "eva": random.randint(1,8), "sab": random.randint(1,8), "arc": random.randint(1,8), "car": random.randint(1,8)}
