...
nomes_italo_continental = pd.read_csv("arquivos/nomes_italo_continental.csv")

def merc_void():
    nome = random.choice(nomes_italo_continental['Personagem'])

    atributos1 = {"for": random.randint(1,8), "vig": random.randint(1,8), "des": random.randint(1,8) + random.randint(1,3), "atl": random.randint(1,8), "eva": random.randint(1,8) + random.randint(1,3), "sab": random.randint(1,8), "arc": random.randint(1,8), "car": random.randint(1,8)}
