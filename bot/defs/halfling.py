...
nomes = pd.read_csv("bot/arquivos/csv/nomes_inuites.csv")
...
def merc_halfling():
    ...
    if(escolha == 1):
        atributos1["eva"] += random.randint(1, 3) * random.randint(1, 2)
    else:
        atributos1["car"] += random.randint(1,3) * random.randint(1, 2)
...
def player_halfling():
    ...
    if(escolha == 1):
        atributos["eva"] += random.randint(1, 3) * random.randint(1, 2)
    else:
        atributos["car"] += random.randint(1,3) * random.randint(1, 2)
