...
def merc_arque():
    ...
    atributos1 = {"for": random.randint(1,8), "des": random.randint(1,8), "atl": random.randint(1,8), "eva": random.randint(1,8), "vig": random.randint(1,8), "sab": random.randint(1,8)+ random.randint(1,3) + random.randint(1,3), "arc": random.randint(1,8), "car": random.randint(1,8)}
