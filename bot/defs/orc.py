...
def merc_orc():
    ...
    atributos1 = {"for": random.randint(1,8) + random.randint(1,3), "des": random.randint(1,8) , "atl": random.randint(1,8), "eva": random.randint(1,8), "vig": random.randint(1,8) + random.randint(1,3), "sab": random.randint(1,8), "arc": random.randint(1,8), "car": random.randint(1,8)}
...
def player_orc():
    ...
    atributos = {"for": random.randint(1,10) + random.randint(1,6), "vig": random.randint(1,10) + random.randint(1,6), "des": random.randint(1,10), "atl": random.randint(1,10), "eva": random.randint(1,10), "sab": random.randint(1,10), "arc": random.randint(1,10), "car": random.randint(1,10)}
